...
Das Fastfile wurde noch nicht auf der Gitlab Umgebung getestet, es wurde mit dem Dozenten bzw. Auftraggeber vereinbart, dass dies noch nach der Abgabe der Dokumentation erfolgen kann.
Es muss geprüft werden, ob das Fastfile alle Lanes richtig ausführt und mit den vorhandenen Secrets dann auch die App richtig signiert und in die Google Play Console lädt.