...
Das Fastfile wurde bislang noch nicht in der GitLab-Umgebung getestet. Mit dem Dozenten bzw.\ Auftraggeber wurde vereinbart, dass dieser Test nach der Abgabe der Dokumentation erfolgen kann. Dabei ist zu überprüfen, ob das Fastfile alle Lanes korrekt ausführt und ob die App mit den vorhandenen Secrets ordnungsgemäss signiert sowie in die Google Play Console hochgeladen wird.

Zusätzlich wurde festgestellt, dass im Android-XML-Projekt in der Datei \texttt{gitlab-ci.yml} die Pipelines auf bestimmte Branches beschränkt sind. Diese Einschränkung wurde entsprechend umgesetzt, weshalb ein Test auf dem WIPRO-Branch aktuell nicht möglich ist. Dieses Thema wird bis zur Schlusspräsentation noch mit dem Dozenten besprochen.