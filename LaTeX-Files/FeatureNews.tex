...
die Accompanist-WebView \parencite{noauthor_webview_nodate}. Da diese Library jedoch als \textit{deprecated} markiert
...
\begin{itemize}
  \item \textbf{NewsOverviewWordpressView}:  
        ...
        Die View beobachtet den Ladezustand des \texttt{NewsDataLoader} und reagiert
