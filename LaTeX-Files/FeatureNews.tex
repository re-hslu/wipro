...
die Accompanist-WebView \parencite{google_accompanist_nodate}. Da diese Library jedoch als \textit{deprecated} markiert
wurde, ersetzten wir sie durch die native \newline \texttt{android.webkit.WebView}, welche
...
\subsubsection*{Funktionsweise JSON-View}
...
\subsubsection*{Darstellung der News}
...
\subsubsection*{Herausforderungen und Einschränkungen}
