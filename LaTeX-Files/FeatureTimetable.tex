...
Zugriff auf Kalender und Termine bereit \parencite{noauthor_android_nodate}.  
Die App kann damit:
\begin{itemize}
...
Widget-Architektur von Android \parencite{noauthor_android_nodate-1}.
...
Widget-Konfiguration (\texttt{timetable\_widget\_info.xml}). 
...
Hilt verfügbar ist, erfolgt der Kalenderzugriff direkt über \texttt{CalendarContract}
