\subsection{AppInit} \label{sec:featureappinit}
...
Ein Sequenziagramm des gesamten Ablaufes ist im Anhang zu finden (siehe Anhang ~\ref{anhang:AppBootstrappingViewModel}).
