...
Applikationen neu veröffentlicht werden müssen \parencite{fowler_patterns_2003}. Dadurch wird die Wartbarkeit verbessert
und neue Inhalte können schneller und flexibler bereitgestellt werden (siehe Anhang ~\ref{anhang:backend}).