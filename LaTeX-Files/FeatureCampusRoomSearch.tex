...
Nachdem in dieses Feature sehr viel Zeit investiert und sich herausgestellt hat, dass man mit dem Android PDFRenderer Annotationen nicht richtig analysieren kann wurde und mit dem Dozenten/Auftraggeber das nochmals distutiert wurde
kamen wir zum Schluss, dass wir hier eventuell nicht ganz zu einem befriedigenden Ergebnis gekommen sind. Es wurde abgemacht, dass dieses Feature auch noch nach Abgabe der Dokumentation bis zur Präsentation weiterentwickelt werden kann.
Es soll geprüft werden ob eventuell PDFBox besser geeignet ist.
Ebenfalls funktioniert der Zoom, welcher in der iOS App vorhanden ist noch nicht in der Android App. Hierzu wird ebenfalls noch Zeit investiert und eine Lösung gesucht.