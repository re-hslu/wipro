\subsection{Lokalisierung}\label{sec:localisation}
...
basierend auf dem System-Locale) \parencite{google_localize_nodate}.  
...
\begin{lstlisting}[language=Kotlin, caption={Auswahl der passenden Sprachvariante}]
val label: String
