...
\lstdefinelanguage{Kotlin}{
  keywords={abstract, class, object, interface, fun, val, var,
    if, else, when, for, while, return, is, in, as, this, super},
...
\usepackage{subcaption}                             % Mehrere Bilder bei einer Caption
\usepackage{tabularx}
\usepackage{booktabs}
\usepackage{array}
\usepackage{caption}
...
% Querformat: Kopf-/Fusszeile korrekt drehen
\usepackage{scrlayer-scrpage}
\newpairofpagestyles{landscapeNumber}{scrheadings}{%
  \ihead{}
  \chead{}
  \ohead{}
  \ifoot{}
...
\newpairofpagestyles{landscapescrheadings}{scrheadings}{%
  \lehead{\rotatebox{-90}{\headmark}}%
  \cehead{}%
  \rehead{\rotatebox{-90}{\pagemark}}%
  \lohead{\rotatebox{-90}{HSLU Mobile Apps - Android Jetpack Compose - AI First}}%
  \cohead{}%
  \rohead{\rotatebox{-90}{WIPRO HS25}}%
  \lefoot{}%
  \cefoot{}%
  \refoot{}%
  \lofoot{}%
