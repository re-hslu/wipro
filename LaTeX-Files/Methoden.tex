...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Fotos/sprint_cycle.png}
    \caption{Darstellung des Scrum-Prozesses im Projekt}
    \label{fig:scrum}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Fotos/risikomatrix.png}
