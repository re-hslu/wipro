...
zu trennen und im Code sauber abzubilden \parencite{evans_domain-driven_2003}.
...
Scrum \parencite{atlssian_was_nodate}. Die Arbeit wurde in zweiwöchige Sprints unterteilt, woraus sich insgesamt
...
gesamte Projektdauer hinweg (siehe Anhang ~\ref{anhang:sprintboard-1}).
...
\subsection{Vorgehen beim Einsatz von AI}

Der Einsatz von AI folgte im Projekt einem pragmatischen Vorgehen.
Zu Beginn wurde eine Evaluationsphase durchgeführt, in der verschiedene
AI-Tools getestet und verglichen wurden (siehe Abschnitt~\ref{sec:ai-eval}).
Ziel war es, jene Werkzeuge zu identifizieren, die sich sinnvoll in den
Entwicklungsprozess integrieren lassen.

Während der eigentlichen Projektarbeit wurde AI anschliessend gezielt als
Unterstützung eingesetzt. Dies erfolgte dann hauptsächlich mit Cursor.
Typischerweise liessen wir uns bestehende
iOS-Funktionen erklären, erhielten Vorschläge für mögliche Umsetzungen auf
Android und schätzten diese selbst ein. Auf dieser Basis wurde entschieden,
welcher Ansatz sinnvoll ist. Die ausgewählten Lösungen wurden anschliessend
von AI nach Kotlin umgesetzt und danach manuell überprüft, angepasst und
verbessert.

Je nach Qualität des Resultats wurde der von AI erzeugte Code weiterverwendet
und überarbeitet oder bewusst verworfen und von Hand umgesetzt. Zum Abschluss
wurden die umgesetzten Features erneut überprüft, um sicherzustellen, dass sie
funktional dem iOS-Vorbild entsprechen. Abschliessend wurde ein Fazit zum
Einsatz von AI im Projekt gezogen und reflektiert
(siehe Abschnitt~\ref{sec:ai-reflexion}).