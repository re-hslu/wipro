...
\includepdf[pages=1,pagecommand=\subsection{Aufgabenstellung für AI Tools}]{Anhaenge/Aufgabenstellung_fuerAIs.pdf}
\includepdf[pages=2-,pagecommand={}]{Anhaenge/Aufgabenstellung_fuerAIs.pdf}
    
\label{antwort-chatgpt}
\includepdf[pages=1,pagecommand=\subsection{Antwort von ChatGPT}]{Anhaenge/Aufgabenstellung_Analyse_Vorgehen_CHATGPT.pdf}
\includepdf[pages=2-,pagecommand={}]{Anhaenge/Aufgabenstellung_Analyse_Vorgehen_CHATGPT.pdf}

\label{antwort-grok}
\includepdf[pages=1,pagecommand=\subsection{Antwort von Grok}]{Anhaenge/Antwort_xAI_Grok.pdf}
\includepdf[pages=2-,pagecommand={}]{Anhaenge/Antwort_xAI_Grok.pdf}

\label{antwort-deepseek}
\includepdf[pages=1,pagecommand=\subsection{Antwort von Deepseek}]{Anhaenge/deepseek_antwort.pdf}
\includepdf[pages=2-,pagecommand={}]{Anhaenge/deepseek_antwort.pdf}

\label{antwort-cursor}
\includepdf[pages=1,pagecommand=\subsection{Antwort von Cursor}]{Anhaenge/cursor_antwort.pdf}
